...
def input_window():
    ...
    # labels
    lb = Label(window, text="How big do you want the matrix to be?",
               font=("Arial", 13))
    ...
    init_pos = Label(window, text="Initial positions (x, y):",
                     font=("Arial", 10))
    init_pos.place(relx=0.25, rely=0.45, anchor=CENTER)

    final_pos = Label(window, text="Final positions (x, y):",
                      font=("Arial", 10))
            ...
            for i in range(0, n+1):
                for j in range(0, n + 1):
                    ...
                    # else if the position should be a blank space...
                        ...
                        screen.blit(
                            white_img, (i * image_size, j * image_size))

                    # else if the position is a obstacle
                    elif matrix[i + 1][j + 1] == -1:
                        screen.blit(
                            black_img, (i * image_size, j * image_size))
